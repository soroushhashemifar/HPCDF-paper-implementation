...
public class AggregatedTraceReader {
    ...
    public static final String FILE_ADDRESS = "Traffic-Trace/traffic-pattern.txt"; // the file traffic pattern must be in the same directory that is used to run the Java jar file from the command line
