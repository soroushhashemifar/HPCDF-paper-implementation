...
public class Traffic {
    ...
    public Traffic clone(){
        ...
        tr.lambda_in = this.lambda_in.clone();
        tr.lambdap_in = this.lambdap_in.clone();

        tr.lambda_out = this.lambda_out.clone();

        tr.arrivalInstructionsCloud = this.arrivalInstructionsCloud.clone();
        tr.arrivalInstructionsFog = this.arrivalInstructionsFog.clone();
