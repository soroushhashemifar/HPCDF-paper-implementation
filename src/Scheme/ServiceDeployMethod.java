...
public class ServiceDeployMethod {
    ...
    public static final int PSOCRO = 6;
    ...
    public ServiceDeployMethod clone(){
        ServiceDeployMethod sdm = new ServiceDeployMethod(this.type);

        sdm.variable = this.variable.clone();

        sdm.averageRateOfTraffic = this.averageRateOfTraffic;
        sdm.averageRateOfTrafficPerFogNodePerService = this.averageRateOfTrafficPerFogNodePerService.clone();
        try {
            sdm.averageRateOfAggregatedServiceTrafficPerFogNode = this.averageRateOfAggregatedServiceTrafficPerFogNode.clone();
        } catch (Exception e){
            // Nothing
        }
