...
public class Parameters {
    ...
    public static void initialize() {
        ...
        ArrayFiller.fill1DArrayRandomlyInRange(q, 0.80, 0.99); // high QoS requirements

        th = new double[numServices];
        ArrayFiller.fill1DArrayRandomlyInRange(th, 10d, 15d); // 10 ms is the threshold (architectural imperatives is my reference for this)
        ...
        ArrayFiller.fill1DArrayRandomlyInRange(KM, 4d * 1000d * 1000d * 1000d * 8d, 16d * 1000d * 1000d * 1000d * 8d); // 4~16 GB

        KpM = new double[numCloudServers];
        ArrayFiller.fill1DArrayRandomlyInRange(KpM, 8d * 1000d * 1000d * 1000d * 8d, 32d * 1000d * 1000d * 1000d * 8d); // 8~32 GB

        KS = new double[numFogNodes];
        ArrayFiller.fill1DArrayRandomlyInRange(KS, 10d * 1000d * 1000d * 1000d * 8d, 25d * 1000d * 1000d * 1000d * 8d); // 10~25 GB

        KpS = new double[numCloudServers];
        ArrayFiller.fill1DArrayRandomlyInRange(KpS, 100d * 1000d * 1000d * 1000d * 8d, 250d * 1000d * 1000d * 1000d * 8d); // 100~250 GB
